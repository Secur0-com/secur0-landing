...
**IMPORTANTE**: le invitamos a que lea detenidamente esta Política de Privacidad para conocer por qué recopilamos sus datos personales y cómo son procesados dichos datos por HACK 4 BOUNTY, SL, Calle del Cardenal Cisneros 54, 2 d, 28010 Madrid.  

Esta política está sujeta a cambios por lo que es conveniente consultarla cada vez que Usted decida visitarnos.  
La presente Política de Privacidad fue modificada el 24/2/2025.

## ÁMBITO

Esta declaración de privacidad en línea de HACK 4 BOUNTY, SL, es pública y accesible a todos los usuarios y clientes de HACK 4 BOUNTY, SL, y se aplica a todos los sitios web, aplicaciones, eventos y otros servicios de HACK 4 BOUNTY, SL, siendo secur0.com el sitio o dominio principal.  
También se aplica a aquellos documentos o mensajes emitidos por HACK 4 BOUNTY, SL. que enlazan a esta política o declaración de privacidad o, en su caso, indican que se acceda a ella para que Ud. conozca el uso que hace HACK 4 BOUNTY, SL de sus datos personales.  
Algunos servicios pueden tener sus propias políticas de privacidad. Si es así, esas políticas se aplican en lugar de esta.  
...
Información sobre el uso de datos de carácter personal, según lo dispuesto en el Reglamento (UE) 2016/679 del Parlamento Europeo y del Consejo de 27 de abril de 2016 relativo a la protección de las personas físicas, en lo que respecta al tratamiento de datos personales y a la libre circulación de estos datos (RGPD) y la Ley Orgánica 3/2018, de 5 de diciembre, de Protección de Datos Personales y Garantía de los Derechos Digitales, que adapta el Reglamento al ordenamiento jurídico español y completa y desarrolla sus disposiciones (LOPDGDD).  
HACK 4 BOUNTY, SL, respeta su derecho a la intimidad y aplica toda la normativa vigente con objeto de proteger los datos personales de sus clientes y usuarios.   
Sus datos personales son tratados con la máxima confidencialidad, habiendo adoptado HACK 4 BOUNTY, SL, como Responsable del Tratamiento, las medidas de orden técnico y organizativo necesarias para garantizar la confidencialidad y seguridad de los datos personales, evitando su alteración, pérdida, tratamiento o acceso no autorizado.

* Para que Usted pueda recibir información y, en su caso, poder reservar o usar los productos y servicios que HACK 4 BOUNTY, SL, ofrece a través del/de los sitio/s de HACK 4 BOUNTY, SL, es necesario que nos informe de ciertos datos personales necesarios para poder, así, personalizar nuestros servicios y ajustarlos a sus intereses y necesidades. 

Le recordamos que es deber del usuario hacernos saber cualquier cambio que se produzca en sus datos, a HACK 4 BOUNTY, SL, y que hubiera registrado nuestros sitios, para proceder a su mantenimiento en los ficheros correspondientes.  
Para mejorar los servicios que le ofrecemos, es posible reciba una encuesta de satisfacción. En ella se le pedirá una valoración de los servicios recibidos y un breve comentario sobre la experiencia vivida.  
Recopilamos su información personal por varios motivos:

* Cuando crea una cuenta, nos proporciona sus datos de inicio de sesión, información básica del perfil (por ejemplo, género, fecha de nacimiento).  
...
* Puede acceder y actualizar su información personal directamente dentro de nuestro servicio.  
...
* De oposición y limitación, para que los datos personales no sean tratados \-desde que se tramite su solicitud- para la finalidad del servicio de calidad.  
* De rectificación en el caso que considere que los datos no son correctos o bien porque han cambiado.
